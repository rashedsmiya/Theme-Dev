            ...
            <div class="col-md-9 col-sm-12 col-xs-12">
                <div class="left-side">
                    <div class="item-holder">
                        <div class="image-box">
                            <figure>
                                <a href="single-blog.html"><img src="<?php echo get_template_directory_uri();?>/images/blog/5.jpg" alt=""></a>
                            </figure>
                        </div>
                    ...
                    <div class="item-holder">
                        <div class="image-box">
                            <figure>
                                <a href="single-blog.html"><img src="<?php echo get_template_directory_uri();?>/images/blog/6.jpg" alt=""></a>
                            </figure>
                        </div>
                        <div class="content-text">
                    ...
                    <div class="item-holder">
                        <div class="image-box">
                            <figure>
                                <a href="single-blog.html"><img src="<?php echo get_template_directory_uri();?>/images/blog/7.jpg" alt=""></a>
                            </figure>
                        </div>
                        <div class="content-text">
                    ...
                    <div class="item-holder">
                        <div class="image-box">
                            <figure>
                                <a href="single-blog.html"><img src="<?php echo get_template_directory_uri();?>/images/blog/8.jpg" alt=""></a>
                            </figure>
                        </div>
                        <div class="content-text">
